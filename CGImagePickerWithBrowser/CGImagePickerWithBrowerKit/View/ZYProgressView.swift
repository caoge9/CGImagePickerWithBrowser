...
class CGProgressView: UIView {
    ...
    static func showCGProgressView(in parentView: UIView, frame: CGRect) -> CGProgressView {
        
        var progressView = parentView.viewWithTag(9999) as? CGProgressView
        
        guard (progressView != nil) else {
            progressView = CGProgressView(frame: frame)
