//
//  CGPreviewCollectionViewCell.swift
...
class CGPreviewCollectionViewCell: UICollectionViewCell, UIScrollViewDelegate {
    ...
    var photoImage: UIImage? {
        didSet {
            ...
            let frame = CGRect(x: 0, y: 0, width: CGScreenWidth, height: imageHeight)
