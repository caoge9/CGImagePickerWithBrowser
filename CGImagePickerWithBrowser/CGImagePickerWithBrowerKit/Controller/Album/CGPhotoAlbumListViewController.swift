//
//  CGPhotoAlbumListViewController.swift
...
class CGPhotoAlbumListViewController: CGBaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private lazy var albumTableView: UITableView = {
        let tableView = UITableView(frame: CGRect(x: 0, y: CGNavigationTotalHeight, width: CGScreenWidth, height: CGScreenHeight-CGNavigationTotalHeight), style: .plain)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var albumsCell: CGAlbumCell? = tableView.dequeueReusableCell(withIdentifier: "AlbumsCell") as? CGAlbumCell
        if albumsCell == nil {
            albumsCell = CGAlbumCell(style: .default, reuseIdentifier: "AlbumsCell")
        }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let photoAlbumViewController = CGPhotoAlbumViewController()
...
private class CGAlbumCell: UITableViewCell {
